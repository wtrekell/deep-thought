...
def strip_frontmatter(text: str) -> str:
    ...
    # NOTE: This takes the first occurrence of "---" after line 0 as the closing
    # delimiter. If the content body itself contains a line with only "---", it
    # would prematurely truncate the output. This is acceptable because all
    # frontmatter is machine-generated by write_transcript(), which never emits
    # bare "---" lines in its field values.
