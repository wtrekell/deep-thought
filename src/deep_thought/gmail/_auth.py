"""OAuth 2.0 token management for the Gmail Tool.
...
def get_credentials(credentials_path: str, token_path: str, scopes: list[str]) -> Credentials:
    """Load, refresh, or obtain OAuth 2.0 credentials for the Gmail API.
    ...
    """
    return get_oauth_credentials(_GMAIL_SERVICE, credentials_path, token_path, scopes)
