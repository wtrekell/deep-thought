...
1. **2026-03-18** — Added requirements drafts for 15+ future tools (PDF, Office, audio, video, image, text, data, email, markdown, web, Gmail, Reddit, research, Stack Exchange, YouTube, Krea, APNG, ElevenLabs) under `files/tools/00-requirements/`
