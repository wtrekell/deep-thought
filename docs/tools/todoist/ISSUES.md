...
This file is a working scratch-pad for observations about the todoist tool that have not yet been triaged. When an entry is reviewed it is handled in whichever way fits best:
