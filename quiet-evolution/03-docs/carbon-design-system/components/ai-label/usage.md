...
mode: documentation
title: "AI label – Carbon Design Systeminfo iconOpen menuOpen menu"
word_count: 2203
processed_date: 2026-04-14T05:07:26.127406+00:00
---

# AI label

  * [Usage](https://carbondesignsystem.com/components/ai-label/usage/)
  * [Style](https://carbondesignsystem.com/components/ai-label/style/)
  * [Code](https://carbondesignsystem.com/components/ai-label/code/)
  * [Accessibility](https://carbondesignsystem.com/components/ai-label/accessibility/)
...
**New!** [AI label](https://react.carbondesignsystem.com/?path=/docs/components-ailabel--overview) is now a stable component. The AI label was previously called “AI Slug” but has been changed to better reflect its usage.
...
This live demo contains only a preview of functionality and styles available for this component. View the [full demo](https://react.carbondesignsystem.com/?path=/story/components-ailabel--default&globals=theme:white) on Storybook for additional information such as its version, controls, and API documentation.
...
##### [Default stateTested](https://carbondesignsystem.com/components/ai-label/accessibility/#accessibility-testing-status)

##### [Advanced statesTested](https://carbondesignsystem.com/components/ai-label/accessibility/#accessibility-testing-status)

##### [Screen readerManually tested](https://carbondesignsystem.com/components/ai-label/accessibility/#accessibility-testing-status)

##### [Keyboard navigationNot available](https://carbondesignsystem.com/components/ai-label/accessibility/#accessibility-testing-status)
...
### Anatomy
  ...
  1. **AI indicator / button** : indicates AI is present and is the button trigger for the explainability popover. It can be either the default or inline variant.
  2. **Text label** : the text abbreviation for artificial intelligence which can be translated as needed.
  3. **Explainability popover** : Area that contains AI explainability content and interactive elements.
...
The size of the inline AI label text should match the size of the text it is placed inline with. For example, when inserting the inline AI label into a table row with 14px font size, you match it with the medium-size inline AI label that also has a 14px font.
...
If other icons are present alongside the AI label, then the AI label should be placed in the far left position of the icon group.
...
Where the AI label is positioned inside of a data table depends on which parts of the data are AI generated. For more details, see the [AI presence](https://carbondesignsystem.com/components/data-table/usage/#ai-presence) section on the data table component page.
...
Where the AI label is placed in a form can vary depending on if the AI presence is across the whole form or just in certain parts of the form. For more guidance, see the [AI presence](https://carbondesignsystem.com/components/form/usage/#ai-presence) section on the form component page.
...
Use both focused and broad AI labels when AI surfaces throughout the experience, but:
...
An example of broad AI labeling on the whole chat conversation but focused AI labeling on a single message.
...
_For IBMers only:_ For more information and guidance on designing content for your explainability popover, see the [AI explainability popover](https://w3.ibm.com/w3publisher/design-for-ai/carbon-for-ai/ai-explainability-popover) pattern on Design for AI.

## Behaviors

### States

AI label has three interactive states: **enabled** , **hover** , and **focus**. The AI label should never be disabled as part of a disabled or read-only state. Learn more about states on the [style](https://carbondesignsystem.com/components/ai-label/style) tab.

Enabled (left), hover (middle), focus (right)

### Clickable areas

In the default AI label, the clickable area is limited to the icon without any additional external coverage, such as in an icon-only ghost button. The inline AI label will have a small amount of extra padding around it included in the click target area.
...
The AI label is the trigger that opens explainability popover. The interaction works like a toggletip where the popover remains open until the user clicks or tabs away from the AI label. For a details on the keyboard interactions of the explainability popover, see the [accessibility](https://carbondesignsystem.com/components/ai-label/accessibility#keyboard-interactions) tab.

#### Popover orientation

The popover should auto-position itself to the best orientation on the screen so that it does not appear out of view for the user. It follows the same alignments as the primitive caret-tip [popover](https://carbondesignsystem.com/components/popover/usage/#caret-tip).
...
#### Components
  ...
  * [Checkbox](https://carbondesignsystem.com/components/checkbox/usage/#ai-presence)
  * [Data table](https://carbondesignsystem.com/components/data-table/usage/#ai-presence)
  * [Date picker](https://carbondesignsystem.com/components/date-picker/usage/#ai-presence)
  * [Dropdown](https://carbondesignsystem.com/components/dropdown/usage/#ai-presence)
  * [Form](https://carbondesignsystem.com/components/form/usage/#ai-presence)
  * [Modal](https://carbondesignsystem.com/components/modal/usage/#ai-presence)
  * [Number input](https://carbondesignsystem.com/components/number-input/usage/#ai-presence)
  * [Popover](https://carbondesignsystem.com/components/popover/usage/)
  * [Radio button](https://carbondesignsystem.com/components/radio-button/usage/#ai-presence)
  * [Select](https://carbondesignsystem.com/components/select/usage/#ai-presence)
  * [Tag](https://carbondesignsystem.com/components/tag/usage/#ai-presence)
  * [Text input](https://carbondesignsystem.com/components/text-input/usage/#ai-presence)
  * [Tile](https://carbondesignsystem.com/components/tile/usage/#ai-presence)
...
[Edit this page on GitHub](https://github.com/carbon-design-system/carbon-website/edit/main/src/pages/components/ai-label/usage.mdx)
